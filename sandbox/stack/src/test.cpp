...
TEST(Stack_test, Size_test) {
  auto stack = Stack<float>();
  ASSERT_EQ(stack.Size(), 0);
}

TEST(Stack_test, PushTop_test) {
  auto stack = Stack<int>();
  stack.Push(6);
  ASSERT_EQ(stack.Top(), 6);
}

TEST(Stack_test, PushTopPop_test_1) {
...
TEST(Stack_test, PushTopPop_test_2) {
  auto stack = Stack<string>();
...
TEST(Stack_test, PushSize_test_1) {
  auto stack = Stack<int>();
  stack.Push();
  stack.Push();
...
TEST(Stack_test, PushSize_test_2) {
...
TEST(Stack_test, PushSize_test_3) {
  struct A {
    double a;
    string s;
    vector<A> b;
...
TEST(Stack_test, PushPop_test_1) {
  auto stack = Stack<double>();
  stack.Push();
  stack.Push();
  stack.Push();
...
TEST(Stack_test, PushPop_test_2) {
  auto stack = Stack<double>();
  stack.Push();
  stack.Push();
  stack.Pop();
...
TEST(Stack_test, PushRange_initializer_list_SizePopTop_test) {
  auto stack = Stack<int>();
...
TEST(Stack_test, PushRange_vector_SizePopTop_test_1) {
  auto stack = Stack<int>();
...
TEST(Stack_test, PushRange_vector_SizePopTop_test_2) {
  auto stack = Stack<int>();
...
TEST(Stack_test, PushRange_std_stack_SizePopTop_test) {
  auto stack = Stack<int>();
...
TEST(Stack_test, PushRange_Stack_SizePopTop_test) {
  auto stack = Stack<int>();
  Stack<int> my_stack;
  my_stack.Push(1);
  my_stack.Push(2);
