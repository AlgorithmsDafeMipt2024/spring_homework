...
TEST(TopologySort, MultipleCases) {
  ASSERT_EQ(Task3(std::vector<int>{73, 74, 75, 71, 69, 72, 76, 73}),
            (std::vector<int>{1, 1, 4, 2, 1, 1, 0, 0}));
  ASSERT_EQ(Task3(std::vector<int>{30, 40, 50, 60}),
            (std::vector<int>{1, 1, 1, 0}));
  ASSERT_EQ(Task3(std::vector<int>{30, 60, 90, 70, 80, 40, 30}),
            (std::vector<int>{1, 1, 0, 1, 0, 0, 0}));
  ASSERT_EQ(Task3(std::vector<int>{55, 55, 55, 55, 55}),
